@extends('layouts.admin', ['accesses' => $accesses, 'active' => 'profile'])
          ...
          <div class="row">
            <div class="col-12">
              <div class="form-group">
                ...
                <input type="name" class="form-control @error('name') is-invalid @enderror" name="name" id="name" placeholder="Enter name" value="{{ $profile->name }}">
              </div>
              @error('name')
                <div class="alert alert-danger">{{ $message }}</div>
              @enderror
              ...
              <div class="form-group">
                ...
                <input type="phone" class="form-control @error('phone') is-invalid @enderror" name="phone" id="phone" placeholder="Enter phone" value="{{ $profile->employee->employeeDetail->phone }}">
              </div>
              @error('phone')
                <div class="alert alert-danger">{{ $message }}</div>
              @enderror
              <div class="form-group">
                ...
                <input type="address" class="form-control @error('address') is-invalid @enderror" name="address" id="address" placeholder="Enter address" value="{{ $profile->employee->employeeDetail->address }}">
              </div>
              @error('address')
                <div class="alert alert-danger">{{ $message }}</div>
              @enderror
