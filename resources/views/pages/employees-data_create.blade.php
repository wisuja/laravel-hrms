            ...
            <div class="row">
              ...
              <div class="col-sm-12 col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" name="dateOfBirth" id="dateOfBirth" class="form-control" value="{{ old('dateOfBirth') }}" placeholder="Enter date of birth">
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-sm-12 col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" name="identityNumber" id="identityNumber" class="form-control" value="{{ old('identityNumber') }}" placeholder="Enter identity number">
                </div>
              </div>
              <div class="col-sm-12 col-lg-6">
                <div class="form-group">
